      ...
      <style>
        {`
          ...
          .fallfest-hover-bg:hover {
            background-color: rgba(252, 211, 77, 0.3); /* yellow-300 bg with opacity */
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={`text-sm font-display transition-colors px-2 py-1 ${
                  pathname === item.href ? "text-red font-medium" : "text-white hover:text-red"
                }
                ${
                  item.name === "FallFest"
                    ? "text-red-600 blink-animation fallfest-hover-bg"
                    : ""
                }
                `}
              >
                  ...
                  <SheetClose asChild key={item.name}>
                    ...
                    >
                      <SheetTitle
                        className={`${
                          item.name === "FallFest"
                            ? "text-yellow-400 hover:text-yellow-500 blink-animation fallfest-hover-bg"
