...
export default function Footer() {
  ...
  const footerLinks = [
    ...
    },
    {
      title: "Connect",
      links: [
        { name: "LinkedIn", href: "https://www.linkedin.com/company/symbiosis-quantum-club/" },
        { name: "Instagram", href: "https://www.instagram.com/quantumclub.sit/" },
        { name: "GitHub", href: "https://github.com/Symbiosis-Quantum-Club" },
      ],
    },
  ];
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/symbiosis-quantum-club/posts/?feedView=all",
      icon: (
