  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Legacy Quantum mapping (for backward compatibility)
        'quantum-bg': '#0B0F1A',
        'quantum-bg-secondary': '#12182B',
        'quantum-bg-tertiary': '#0F1424',
        ...
        'quantum-text': '#E6F1FF',
        'quantum-text-secondary': '#8FA2C9',
        'quantum-text-muted': '#5A6B91',
        'quantum-border': 'rgba(255,255,255,0.08)',
        'quantum-surface': '#1A2238',
      },
      animation: {
